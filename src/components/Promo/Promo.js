    ...
    <section className="promo">
      ...
      <div className="promo__card promo__card_top-right">
        <div className="promo__content-container">
          ...
          <NavLink to={`/movie/1`} className="promo__card-more-button promo__card-more-button_top-right">Подробнее</NavLink>
        </div>
      ...
      <div className="promo__card promo__card_small">
        <NavLink to={`/movie/2`} className="promo__card-title promo__card-title_small">{MOVIES_DATA[2].title}</NavLink>
        <img className="promo__card-image" src={MOVIES_DATA[2].poster} alt={MOVIES_DATA[2].title}></img>
      </div>
      <div className="promo__card promo__card_small">
        <NavLink to={`/movie/3`} className="promo__card-title promo__card-title_small">{MOVIES_DATA[3].title}</NavLink>
