...
function Promo() {
  return (
    <section className="promo">
      ...
      <div className="promo__card promo__card_small" style={{ backgroundImage: `url(${poster3})`}}>
        <h2 className="promo__card-title promo__card-title_small">Дом на другой стороне</h2>
      </div>
      <div className="promo__card promo__card_small" style={{ backgroundImage: `url(${poster4})`}}>
