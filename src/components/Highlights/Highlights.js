    ...
    <section className="highlights">
      ...
      <ul className="highlights__container">
        <li className="highlights__list-item">
          <NavLink to={`/movie/${MOVIES_DATA[4].id}`} className="highlights__card">
        ...
        <li className="highlights__list-item">
          <NavLink to={`/movie/${MOVIES_DATA[5].id}`} className="highlights__card">
        ...
        <li className="highlights__list-item">
          <NavLink to={`/movie/${MOVIES_DATA[6].id}`} className="highlights__card">
        ...
        <li className="highlights__list-item">
          <NavLink to={`/movie/${MOVIES_DATA[7].id}`} className="highlights__card">
